...
public class GestionTipoAdquisiciones extends javax.swing.JInternalFrame implements Gestionable {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("SISPA - Tipos de Adquisicion");
        ...
        jlTituloPrincipal.setText("SISPA - Tipos de Adquisicion");
        jpTitulo.add(jlTituloPrincipal, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 0, 490, 70));
    ...
    private void jbEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbEliminarActionPerformed
        if (jtTipoAdquisiciones.getSelectedRow() > -1) {
            ...
            try {
                ...
                util.Util.centrarInternalVentana(gestionTipoAdquisiciones, abmTipoAdquisiciones);
