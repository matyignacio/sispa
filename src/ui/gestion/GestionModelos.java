...
import ui.abm.AbmModelo;
import ui.grillas.GrillaModelos;
...
public class GestionModelos extends javax.swing.JInternalFrame implements Gestionable {
    ...
    private void initComponents() {
        ...
        jpPrincipal.setMinimumSize(new java.awt.Dimension(1100, 710));
        ...
        jtModelos.setBackground(new java.awt.Color(204, 204, 204));
        jtModelos.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jtModelos.setForeground(new java.awt.Color(33, 150, 243));
        ...
        desktopPaneLayout.setHorizontalGroup(
            ...
            .addGroup(desktopPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(desktopPaneLayout.createSequentialGroup()
                    .addComponent(jpPrincipal, javax.swing.GroupLayout.PREFERRED_SIZE, 1171, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jbEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbEliminarActionPerformed
        if (jtModelos.getSelectedRow() > -1) {
            ...
            try {
                ...
                util.Util.centrarInternalVentana(gestionModelos, abmModelo);
                abmModelo.show();
    ...
    private void jbNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbNuevoActionPerformed
        ...
        GestionModelos gestionModelos;
        try {
            abmModelo = new AbmModelo(ABM_ALTA, new Modelo(), this);
            this.desktopPane.add(abmModelo);
            gestionModelos = new GestionModelos();
            util.Util.centrarInternalVentana(gestionModelos, abmModelo);
            abmModelo.show();
